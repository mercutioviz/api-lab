...
#  and process the PUT request
#
# Ex:
#  ./put-waf-api.ps1 -api 'services/HTTPS/content-rules' -jsonSourceFile 'C:\temp\mydat.json'
#
param(
...
$r = Invoke-WebRequest -uri $url -Method Put -Body $bodyJSON -Headers $headers -ContentType $contentType -SkipCertificateCheck
